		...
		<div class="uo-row uo-groups-actions">
			<div class="group-management-buttons">
				...
				<div class="group-management-buttons__right">
					...
					<?php
					$report_menu_items = array(
						'progress_report_button' => '',
						'quiz_report_button'     => '',
						'progress_management_report_button' => '',
						'assignment_button'      => '',
						'essay_button'           => '',
					);

					if ( $progress_report_button && ! empty( SharedFunctions::get_group_report_page_id() ) ) {
						$report_menu_items['progress_report_button'] = '<button class="ulgm-link uo-btn"
											onclick="location.href=\'' . GroupManagementInterface::$ulgm_management_shortcode['text']['group_progress_link'] . '\'"
											type="button"
											tabindex="0">
										' . GroupManagementInterface::$ulgm_management_shortcode['text']['group_progress'] . '
									</button>';
					}

					if ( $quiz_report_button && ! empty( SharedFunctions::get_group_quiz_report_page_id() ) ) {
						$report_menu_items['quiz_report_button'] = '<button class="ulgm-link uo-btn uo-right"
											onclick="location.href=\'' . GroupManagementInterface::$ulgm_management_shortcode['text']['group_quiz_progress_link'] . '\'"
											type="button"
											tabindex="0">
										' . GroupManagementInterface::$ulgm_management_shortcode['text']['group_quiz_progress'] . '
									</button>';
					}

					if ( $progress_management_report_button && ! empty( SharedFunctions::get_group_manage_progress_report_page_id() ) ) {
						$report_menu_items['progress_management_report_button'] = '<button class="ulgm-link uo-btn uo-right"
											onclick="location.href=\'' . GroupManagementInterface::$ulgm_management_shortcode['text']['group_progress_management_link'] . '\'"
											type="button"
											tabindex="0">
										' . GroupManagementInterface::$ulgm_management_shortcode['text']['group_progress_management'] . '
									</button>';
					}

					if ( $assignment_button && ! empty( SharedFunctions::$group_assignment_report_page_id ) ) {
						$report_menu_items['assignment_button'] = '<button class="ulgm-link uo-btn uo-right"
											onclick="location.href=\'' . GroupManagementInterface::$ulgm_management_shortcode['text']['group_assignment_link'] . '\'"
											type="button"
											tabindex="0">
										' . GroupManagementInterface::$ulgm_management_shortcode['text']['group_assignment_page'] . '
									</button>';
					}

					if ( $essay_button && ! empty( SharedFunctions::$group_essay_report_page_id ) ) {
						$report_menu_items['essay_button'] = '<button class="ulgm-link uo-btn uo-right"
											onclick="location.href=\'' . GroupManagementInterface::$ulgm_management_shortcode['text']['group_essay_link'] . '\'"
											type="button"
											tabindex="0">
					...
					if ( is_array( $report_menu_items ) && ! empty( $report_menu_items ) ) {
						?>
						<div class="uo-groups-list-of-btns uo-inline-block uo-right"
							...
							<div class="uo-groups-list">
								<?php
								foreach ( $report_menu_items as $item_index => $item_output ) {
									echo $item_output;
								}
								?>
							</div>
