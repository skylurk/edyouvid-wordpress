...
/**
 * Class GFCodeFieldAddOnCodes
 */
class GFCodeFieldAddOnCodes extends GFAddOn {
	 ...
	 *
	 * @param array $tooltips An associative array of tooltips where the key is the tooltip name and the value is the
	 *                        tooltip.
	 *
	 * @return array
	 */
	public function tooltips( $tooltips ) {
		$simple_tooltips = array(
			'input_class_setting' => sprintf( '<h6>%s</h6>%s', esc_html__( 'Input CSS Classes', 'uncanny-learndash-codes' ), esc_html__( 'The CSS Class names to be added to the field input.', 'uncanny-learndash-codes' ) ),
		);
