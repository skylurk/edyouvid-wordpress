...
function uo_get_server_database_version() {
	...
	if ( $db_server_info['mysqldb_active'] ) {
		...
		$db_type         = __( 'MySQL Version', 'uncanny-learndash-codes' );
		...
		$db_type         = __( 'MariaDB Version', 'uncanny-learndash-codes' );
		$db_version      = $db_server_info['db_version_found'];
...
$table_enviroment->rows[] = array(
	__( 'Server info', 'uncanny-learndash-codes' ),
...
$table_wordpress_settings->rows[] = array(
	__( 'WordPress address (URL)', 'uncanny-learndash-codes' ),
	get_option( 'home' ),
);
$table_wordpress_settings->rows[] = array(
	__( 'Site address', 'uncanny-learndash-codes' ),
	get_option( 'siteurl' ),
);
...
$table_wordpress_plugins = (object) array(
	'title'   => __( 'Active WordPress Plugins', 'uncanny-learndash-codes' ),
	'heading' => array(
...
$tables[] = (object) array(
	...
	'rows'    => array(
		array(
			__( 'Version', 'uncanny-learndash-codes' ),
			defined( 'LEARNDASH_VERSION' ) ? LEARNDASH_VERSION : __( 'LearnDash not active', 'uncanny-learndash-codes' ),
		),
		array(
			__( 'DB Version', 'uncanny-learndash-codes' ),
			defined( 'LEARNDASH_SETTINGS_DB_VERSION' ) ? LEARNDASH_SETTINGS_DB_VERSION : __( 'LearnDash not active', 'uncanny-learndash-codes' ),
		),
		array(
