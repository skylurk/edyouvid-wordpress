...
<div class="ulc-header">
	<div class="ulc-header-top">
		<div class="ulc-header-top__title">
			<?php esc_html_e( 'Uncanny Codes', 'uncanny-learndash-codes' ); ?>
		</div>
		<div class="ulc-header-top__author">
			<span><?php esc_html_e( 'by', 'uncanny-learndash-codes' ); ?></span>
			<a href="https://www.uncannyowl.com/?utm=uncanny-codes" target="_blank" class="ulc-header-top__logo">
