...
if (!class_exists('MCProtectFWRuleEngine_V647')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V647 {
	use MCProtectFWRuleStringFunc_V647;
	use MCProtectFWRuleArrayFunc_V647;
	use MCProtectFWRuleMiscFunc_V647;
	use MCProtectFWRuleRequestFunc_V647;
	use MCProtectFWRuleWPFunc_V647;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V647::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V647 $e) {
			$this->error = $e;
		}
	}
