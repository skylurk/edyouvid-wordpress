 ...
 *
 * This file contains the second preset theme for LoginPress Pro.
 *
...
function second_presets() {
	...
	<style media="screen" id="loginpress-style">
		...
		body.login {
			--background-desktop-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg2.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
			background-image: var(--background-desktop-image, url(<?php echo esc_url( plugins_url( 'assets/img/bg2.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>));
		...
		.loginpress-show-love a, .social-sep span{
			color: #fff;
		}
...
echo second_presets(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
