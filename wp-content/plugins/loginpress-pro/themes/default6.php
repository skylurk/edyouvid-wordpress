 ...
 *
 * This file contains the sixth preset theme for LoginPress Pro.
 *
...
function sixth_presets() {
	...
	<style media="screen" id="loginpress-style">
		...
		#login:after{
			...
			top: 0;
			height: 100%;
			---background-desktop-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg6.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
			background-image: var(--background-desktop-image, url(<?php echo esc_url( plugins_url( 'assets/img/bg6.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>));
			background-repeat: no-repeat;
			background-position: center center;
			background-size: cover;
...
echo sixth_presets(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
