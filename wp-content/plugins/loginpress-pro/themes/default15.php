 ...
 *
 * This file contains the fifteenth preset theme for LoginPress Pro.
 *
...
/**
 * Fifteenth preset theme function.
 *
...
function fifteenth_presets() {
	...
	<style media="screen" id="loginpress-style">
		...
		body.login {
			--background-desktop-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg15.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
			background-image: var(--background-desktop-image, url(<?php echo esc_url( plugins_url( 'assets/img/bg15.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>));
...
echo fifteenth_presets(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
