 ...
 *
 * This file contains the eighth preset theme for LoginPress Pro.
 *
...
function eighth_presets() {
	...
	body.login {
		/* Background image and size styling. */
			position: relative;
			min-height: 700px;
			padding-right: 50%;
		}
		...
		body.login:after{
			...
			right:0;
			height: 100%;
			---background-desktop-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg8.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
			background-image: var(--background-desktop-image, url(<?php echo esc_url( plugins_url( 'assets/img/bg8.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>));
...
echo eighth_presets(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
