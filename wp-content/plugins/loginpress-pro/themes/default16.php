 ...
 *
 * This file contains the sixteenth preset theme for LoginPress Pro.
 *
...
/**
 * Sixteenth preset theme function.
 *
...
function sixteenth_presets() {
	...
	<style media="screen" id="loginpress-style">
		...
		body.login {
			--background-desktop-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg16.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
			background-image: var(--background-desktop-image, url(<?php echo esc_url( plugins_url( 'assets/img/bg16.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>));
...
echo sixteenth_presets(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
