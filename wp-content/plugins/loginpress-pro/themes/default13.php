 ...
 *
 * This file contains the thirteenth preset theme for LoginPress Pro.
 *
...
/**
 * Thirteenth preset theme function.
 *
...
function thirteenth_presets() {
	...
	<style media="screen" id="loginpress-style">
		...
		body.login {
			--background-desktop-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg13.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
			background-image: var(--background-desktop-image, url(<?php echo esc_url( plugins_url( 'assets/img/bg13.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>));
...
echo thirteenth_presets(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
