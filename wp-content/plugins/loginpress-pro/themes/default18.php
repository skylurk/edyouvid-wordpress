 ...
 *
 * This file contains the eighteenth preset theme for LoginPress Pro.
 *
...
/**
 * Eighteenth preset theme function.
 *
...
function eighteenth_presets() {
	...
	<style media="screen" id="loginpress-style">
		...
		body.login {
			--background-desktop-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg18.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
			background-image: var(--background-desktop-image, url(<?php echo esc_url( plugins_url( 'assets/img/bg18.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>));
...
echo eighteenth_presets(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
