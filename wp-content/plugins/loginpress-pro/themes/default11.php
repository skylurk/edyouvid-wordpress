 ...
 *
 * This file contains the eleventh preset theme for LoginPress Pro.
 *
...
/**
 * Eleventh preset theme function.
 *
...
function eleventh_presets() {
	...
	<style media="screen" id="loginpress-style">
		...
		html, body.login {
			...
			body.login {
			--background-desktop-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg11.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
			background-image: var(--background-desktop-image, url(<?php echo esc_url( plugins_url( 'assets/img/bg11.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>));
		...
		.wp-core-ui #login .wp-generate-pw{
			background-color: #174cc333;
			color: #174cc3;
			border: 1px solid #174cc3;
		}
...
echo eleventh_presets(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
