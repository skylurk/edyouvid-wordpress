 ...
 *
 * This file contains the third preset theme for LoginPress Pro.
 *
...
function third_presets() {
	...
	<style media="screen" id="loginpress-style">
		body.login {
			---background-desktop-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg3.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
			background-image: var(--background-desktop-image, url(<?php echo esc_url( plugins_url( 'assets/img/bg3.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>));
...
echo third_presets(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
