 ...
 *
 * This file contains the twelfth preset theme for LoginPress Pro.
 *
...
function twelfth_presets() {
	...
	<style media="screen" id="loginpress-style">
		...
		body.login {
			--background-desktop-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg12.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
			background-image: var(--background-desktop-image, url(<?php echo esc_url( plugins_url( 'assets/img/bg12.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>));
		...
		.wp-core-ui #login .wp-generate-pw{
			background-color: #f8011c33;
			color: #f8011c;
			border: 1px solid #f8011c;
		}
		.login label:after{
			width: 60px;
			height: 45px;
...
echo twelfth_presets(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
