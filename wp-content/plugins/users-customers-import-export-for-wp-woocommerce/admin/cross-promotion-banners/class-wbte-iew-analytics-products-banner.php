...
if ( ! class_exists( 'Wbte_Iew_Analytics_Products_Banner' ) ) {
	...
	class Wbte_Iew_Analytics_Products_Banner {
		...
		private function get_variant_copy( $variant ) {
			if ( 'premium' === $variant ) {
				return array(
					'title'          => __( 'Go beyond basic product imports/exports.', 'users-customers-import-export-for-wp-woocommerce' ),
					'body'           => __( 'Handle variable, subscription, and custom products, automate imports/exports, and map fields effortlessly with advanced features in the Pro version.', 'users-customers-import-export-for-wp-woocommerce' ),
					'cta'            => __( 'Upgrade to Premium', 'users-customers-import-export-for-wp-woocommerce' ),
			...
			// 'suite' default.
			return array(
				'title'          => __( 'Still Managing Data in Pieces?', 'users-customers-import-export-for-wp-woocommerce' ),
				'body'           => __( 'Import, export, and back up users, orders, products, coupons, and more without switching between multiple plugins. Manage it all with a single, unified workflow using Import Export Suite.', 'users-customers-import-export-for-wp-woocommerce' ),
				'cta'            => __( 'Get Import Export Suite', 'users-customers-import-export-for-wp-woocommerce' ),
		...
		public function maybe_inject_banner() {
			...
			$dismiss_btn = esc_attr__( 'Dismiss', 'users-customers-import-export-for-wp-woocommerce' );
