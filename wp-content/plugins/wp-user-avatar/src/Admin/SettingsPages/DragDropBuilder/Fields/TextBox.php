...
class TextBox extends FieldBase
{
    public function field_type()
    {
        return $this->tag_name . '-text-box';
    }

    public static function field_icon()
    {
        return '<span class="dashicons dashicons-editor-textcolor"></span>';
    }

    public function field_title()
    {
        return esc_html__('Text Box', 'wp-user-avatar');
    }
