			...
			<div id="lightbox_title<?php echo $key ?>" class="options hidden" data-item_option="lightbox">
				...
				<ul class="lightbox_button">
					...
					<li>
						...
						<!-- Button -->
						<section id="lightbox_button_custom<?php echo $key ?>" class="snc_custom_image_upload lightbox_button_custom hidden" data-id="lightbox_button_custom_file<?php echo $key ?>" data-item_id="<?php echo $item_id ?>">
							<button type="button">
								<span class="button is-secondary">
									<span class="dashicons dashicons-upload"></span>
									<span><?php _e( 'Click to Upload', 'uncanny-learndash-reporting' ); ?></span>
								</span>
								<span class="button-description"><?php _e( 'No image selected.', 'uncanny-learndash-reporting' ); ?></span>
							</button>
				...
				<div class="nivo_theme" id="nivo_theme<?php echo $key ?>">
					...
					<select class="with_select" name="nivo_transition" id="nivo_transition<?php echo $key ?>">
						<?php foreach( $glightbox_transitions as $cb_key => $cb_value ) { ?>
				...
				<ul class="lightbox_size_options">
					<li>
						<label for="global_lightbox<?php echo $key ?>" class="global_lightbox_label">
							<input type="checkbox" name="global_lightbox" id="global_lightbox<?php echo $key ?>" value="1" checked="checked"/>
							<?php _e( 'Use global Height and Width setting.', 'uncanny-learndash-reporting' ); ?>
						</label>
					</li>
					<li class="lightbox_width_settings" style="display:none;">
					...
					<li class="lightbox_height_settings" style="display:none;">
			...
			<div id="new_window_option<?php echo $key ?>" class="options hidden"  data-item_id="<?php echo $item_id ?>"  data-item_option="_blank">
				...
				<ul class="new_window_option"  data-item_id="<?php echo $item_id ?>">
					...
					<li>
						...
						<!-- Button -->
						<section id="snc-_blank_button<?php echo $key ?>" class="snc_custom_image_upload _blank_button hidden" data-id="_blank_button_custom_file<?php echo $key ?>">
							<button type="button">
								<span class="button is-secondary">
									<span class="dashicons dashicons-upload"></span>
									<span><?php _e( 'Click to Upload', 'uncanny-learndash-reporting' ); ?></span>
			...
			<div id="same_window_option<?php echo $key ?>" class="options hidden"  data-item_id="<?php echo $item_id ?>"  data-item_option="_self">
				...
				<ul class="same_window_option"  data-item_id="<?php echo $item_id ?>">
					...
					<li>
						...
						<!-- Button -->
						<section id="snc-_self_button<?php echo $key ?>" class="snc_custom_image_upload _self_button hidden"  data-id="_self_button_custom_file<?php echo $key ?>">
							<button type="button">
								<span class="button is-secondary">
									<span class="dashicons dashicons-upload"></span>
									<span><?php _e( 'Click to Upload', 'uncanny-learndash-reporting' ); ?></span>
							...
							<input name="upload_self_lightbox_custom_button"  id="snc-upload_self_lightbox_custom_button<?php echo $key ?>" type="file" data-id="_self_button_custom_file<?php echo $key ?>" />
						</section>
