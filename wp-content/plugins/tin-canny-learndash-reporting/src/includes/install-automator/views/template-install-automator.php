	...
	<div class="uo-install-automator__header">
		...
		<div class="uo-install-automator__box">
			...
			<div class="uo-install-automator__text">
				...
				<span><?php esc_html_e( 'By the creators of Uncanny Toolkit & Tin Canny Reporting', 'uncanny-learndash-reporting' ); ?></span>
				...
				<span class="uo-install-automator__rating">
					...
					<img src="<?php echo esc_url( $this->get_image_url( 'icon-star-yellow.svg' ) ); ?>" alt="Yellow star" />
					<img src="<?php echo esc_url( $this->get_image_url( 'icon-star-yellow.svg' ) ); ?>" alt="Yellow star" />
					<img src="<?php echo esc_url( $this->get_image_url( 'icon-star-yellow.svg' ) ); ?>" alt="Yellow half star" />
				</span>
			...
			<div class="uo-install-automator__box">
				...
				<div class="uo-install-automator__text">
					...
					<span class="uo-install-automator__rating">
						...
						<img src="<?php echo esc_url( $this->get_image_url( 'icon-star-yellow.svg' ) ); ?>" alt="Yellow star" />
						<img src="<?php echo esc_url( $this->get_image_url( 'icon-star-yellow.svg' ) ); ?>" alt="Yellow star" />
						<img src="<?php echo esc_url( $this->get_image_url( 'icon-star-yellow.svg' ) ); ?>" alt="Yellow half star" /></span>
				</div>
				<div class="uo-install-automator__button">
