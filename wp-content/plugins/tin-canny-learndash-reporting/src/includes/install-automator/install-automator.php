...
class Install_Automator {
	...
	public function add_small_css_and_js() {
		...
		<script>
			jQuery(document).ready(function ($) {
				'use strict';
				$(".toplevel_page_uncanny-learnDash-reporting .ultc-sidebar-featured-item").parent().addClass("ultc-sidebar-featured-item-container");
			});
		</script>
		<?php
	...
	public function get_installer() {
		if( null === $this->installer ) {
			require_once __DIR__ . '/dependancy/uncanny-one-click-installer/class-auto-plugin-install.php';
