...
<div class="tclr-header <?php echo esc_attr( $css_classes[0] ); ?>">
	...
	<?php if ( is_admin() ) { ?>
		...
		<div class="tclr-header-top">
			...
			<div class="tclr-header-top__author">
				...
				<a href="https://www.uncannyowl.com" target="_blank" class="tclr-header-top__logo">
	...
	<nav class="nav-tab-wrapper uo-admin-reporting-tabs" data-tabgroup="first-tab-group" data-tab_on_load="<?php echo esc_attr( TinCannyShortcode::$current_report_tab ); ?>">
		<div class="tclr-admin-nav">
			<div class="tclr-admin-nav-items">
				<?php foreach ( $tabs as $tab ) { ?>
					...
					if ( TinCannyShortcode::$current_report_tab === $tab->page ) {
					...
					if(is_admin()){
						...
						global $post;
						$href = get_permalink($post->ID). $tab->href_front;
					}

					?>

					<a href="<?php echo esc_attr( $href ); ?>" class="nav-tab <?php echo esc_attr( isset( $css_classes[0] ) ? $css_classes[0] : '' ); ?>" data-tab_id="#<?php echo esc_attr( $tab->id ); ?>">
