...
$table_wordpress_settings = (object) [
	...
	'description' => __( 'Verifies that the xAPI endpoint is accessible. If not, SCORM/Tin Can module data cannot be received and tracked.', 'uncanny-learndash-reporting' ),
	'heading'     => [
