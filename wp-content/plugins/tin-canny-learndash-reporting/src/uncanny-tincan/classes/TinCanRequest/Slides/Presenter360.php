<?php
/**
 * Processing Request : Presenter360
 *
 * @package    Tin Canny Reporting for LearnDash
 * @subpackage TinCan Module
 * @author     eLearning Plus
 * @since      1.3.0
 */
...
class Presenter360 extends \UCTINCAN\TinCanRequest\Slides {
	/**
	 * Constructor
	 *
	 * @access public
	...
	protected function get_module_and_target() {
		...
		if ( count( $this->TC_Context->getContextActivities()->getParent() ) > 1 )
			$target_name = urldecode( \UCTINCAN\ExtendedLanguageMap::get_target($this->TC_Actitity->getDefinition()) );
		else
