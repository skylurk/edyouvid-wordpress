...
function uo_get_server_database_version() {
	...
	if ( $db_server_info['mysqldb_active'] ) {
		...
		$db_type         = __( 'MySQL Version', 'uncanny-ceu' );
		...
		$db_type         = __( 'MariaDB Version', 'uncanny-ceu' );
		$db_version      = $db_server_info['db_version_found'];
...
$min_requirements = ' <a href="https://wordpress.org/about/requirements/" target="_blank">' . __( 'WordPress Minimum Requirements', 'uncanny-ceu' ) . '</a>';
...
$table_enviroment = (object) array(
	'title'   => __( 'Environment', 'uncanny-ceu' ),
	'heading' => array(
		__( 'Setting', 'uncanny-ceu' ),
		__( 'Value', 'uncanny-ceu' ),
	),
	'rows'    => array(),
);

$table_enviroment->rows[] = array(
	__( 'Server info', 'uncanny-ceu' ),
...
//if ( defined( 'PHP_OS' ) ) {
//	$php_version .= __( ' PHP_OS: ', 'uncanny-ceu' ) . PHP_OS;
//}
//
//if ( defined( 'PHP_OS_FAMILY' ) ) {
//	$php_version .= __( ' PHP_OS_FAMILY: ', 'uncanny-ceu' ) . PHP_OS_FAMILY;
//}
...
$table_wordpress_settings = (object) array(
	'title'   => __( 'WordPress Settings', 'uncanny-ceu' ),
	'heading' => array(
		__( 'Setting', 'uncanny-ceu' ),
		__( 'Value', 'uncanny-ceu' ),
	),
...
$table_wordpress_settings->rows[] = array(
	__( 'WordPress address (URL)', 'uncanny-ceu' ),
	get_option( 'home' ),
);
$table_wordpress_settings->rows[] = array(
	__( 'Site address', 'uncanny-ceu' ),
	get_option( 'siteurl' ),
);

// WordPress version
$table_wordpress_settings->rows[] = array(
	__( 'WordPress Version', 'uncanny-ceu' ),
	$wp_version,
);

// Multisite
$table_wordpress_settings->rows[] = array(
	__( 'Multisite', 'uncanny-ceu' ),
	is_multisite() ? __( 'Yes', 'uncanny-ceu' ) : __( 'No', 'uncanny-ceu' ),
);

// Language
$table_wordpress_settings->rows[] = array(
	__( 'Site Language', 'uncanny-ceu' ),
	get_locale(),
);
...
foreach ( $wp_constants as $wp_constant ) {
	$table_wordpress_settings->rows[] = array(
		$wp_constant,
		defined( $wp_constant ) ? constant( $wp_constant ) : __( 'Not defined', 'uncanny-ceu' ),
	);
}

// Object Cache
$table_wordpress_settings->rows[] = array(
	__( 'Object Cache', 'uncanny-ceu' ),
	wp_using_ext_object_cache() ? __( 'Yes', 'uncanny-ceu' ) : __( 'No', 'uncanny-ceu' ),
);
...
$table_wordpress_plugins = (object) array(
	'title'   => __( 'Active WordPress Plugins', 'uncanny-ceu' ),
	'heading' => array(
		__( 'Plugin', 'uncanny-ceu' ),
		__( 'Version', 'uncanny-ceu' ),
	),
	'rows'    => array(),
);
...
$tables[] = (object) array(
	'title'   => __( 'LearnDash Settings', 'uncanny-ceu' ),
	'heading' => array(
		__( 'Setting', 'uncanny-ceu' ),
		__( 'Value', 'uncanny-ceu' ),
	),
	'rows'    => array(
		array(
			__( 'Version', 'uncanny-ceu' ),
			defined( 'LEARNDASH_VERSION' ) ? LEARNDASH_VERSION : __( 'LearnDash not active', 'uncanny-ceu' ),
		),
		array(
			__( 'DB Version', 'uncanny-ceu' ),
			defined( 'LEARNDASH_SETTINGS_DB_VERSION' ) ? LEARNDASH_SETTINGS_DB_VERSION : __( 'LearnDash not active', 'uncanny-ceu' ),
		),
		array(
			__( 'Script Debug', 'uncanny-ceu' ),
			( defined( 'LEARNDASH_SCRIPT_DEBUG' ) ) ? LEARNDASH_SCRIPT_DEBUG : __( 'not defined', 'uncanny-ceu' ),
		),
	),
);
...
$table_php_settings = (object) array(
	'title'   => __( 'PHP Settings', 'uncanny-ceu' ),
	'heading' => array(
		__( 'Setting', 'uncanny-ceu' ),
		__( 'Value', 'uncanny-ceu' ),
	),
