...
ob_start();
include Utilities::get_template( 'admin-siteinfo.php' );
			...
			<?php if ( $license_is_active ) { ?>
				...
				<?php if ( isset( $_GET['sent'] ) ) { ?>
					...
					<div id="message" class="updated notice is-dismissible">
						<p>
							<?php _e( 'Your ticket has been created. Someone at Uncanny Owl will contact you regarding your issue.', 'uncanny-ceu' ); ?>
						</p>
						<button type="button" class="notice-dismiss">
							<span class="screen-reader-text">
								<?php _e( 'Dismiss this notice.', 'uncanny-ceu' ); ?>
							</span>
						</button>
					</div>
							...
							<form name="uncanny-help" method="POST" action="<?php echo admin_url( 'admin.php' ) ?>">
								...
								<div class="uo-send-ticket-form__row">
									<label for="license_key" class="uo-send-ticket-form__label">
										<?php _e( 'License Key', 'uncanny-ceu' ); ?>
									</label>
								...
								<div class="uo-send-ticket-form__row">
									<input type="checkbox" value="yes" name="site-data"
										   checked="checked"> <?php _e( 'Send site data', 'uncanny-ceu' ); ?>
								</div>

								<div class="uo-send-ticket-form__row">
									<p>
										<?php echo __( 'Emails must be enabled on your site to create a ticket using this form. If you don’t receive a confirmation email shortly after submitting this form, please log the ticket through your <a href="https://www.uncannyowl.com/my-account/submit-a-request/" target="_blank" rel="noreferrer">My Account</a> page.', 'uncanny-ceu' ); ?>
									</p>
									<button type="submit" class="uo-send-ticket-form__submit">
										<?php _e( 'Create ticket', 'uncanny-ceu' ); ?>
									</button>
								</div>
							</form>
						</div>
