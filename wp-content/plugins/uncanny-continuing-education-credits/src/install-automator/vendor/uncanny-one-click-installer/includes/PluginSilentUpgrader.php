 ...
 *
 * @internal Please do not use this class outside of core development. May be removed at any time.
 *
 * @since    1.5.6.1
 */
class PluginSilentUpgrader extends Plugin_Upgrader {
	 ...
	 *                                                         Optional. Array or string of arguments for installing a
	 *                                                         package. Default empty array.
	 *
	...
	public function install_package( $args = array() ) {
		...
		Auto_Plugin_Install::set_time_limit( 300 );
