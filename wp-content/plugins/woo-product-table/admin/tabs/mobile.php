        ...
        <tr>
            ...
            <td>
                <select name="mobile[mobile_responsive]" data-name='mobile_responsive' id="wpt_table_mobile_responsive" class="wpt_fullwidth wpt_data_filed_atts ua_select" >
                    ...
                    <option value="no_responsive" <?php echo isset( $meta_mobile['mobile_responsive'] ) && $meta_mobile['mobile_responsive'] == 'no_responsive' ? 'selected' : ''; ?>><?php esc_html_e( 'No Responsive', 'woo-product-table' ); ?></option>
                </select>
                <p>
                    <?php echo esc_html__( 'If you want to work with [Responsive] Tab, Please select [No Responsive].','woo-product-table' ); ?>
                </p>
            </td>
        </tr>
    </table>
