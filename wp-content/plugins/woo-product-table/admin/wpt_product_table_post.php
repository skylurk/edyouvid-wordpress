...
function wpt_product_table_post() {
	...
	$labels = array(
		...
		'all_items'             => __( 'Product Tables', 'woo-product-table' ),
		'add_new_item'          => __( 'Add Table', 'woo-product-table' ),
		// 'add_new'               => __( 'Add New Table', 'woo-product-table' ),
		...
		'not_found'             => __( 'No tables found.', 'woo-product-table' ),
		'not_found_in_trash'    => __( 'No tables found in Trash', 'woo-product-table' ),
