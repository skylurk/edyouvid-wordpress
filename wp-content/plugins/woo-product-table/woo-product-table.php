...
if( ! defined( 'WPT_DEV_VERSION' ) ){
    define( 'WPT_DEV_VERSION', '6.1.2.0' );
}
...
$wpt_old_pro_dir = trailingslashit( WP_PLUGIN_DIR ) . 'woo-product-table-pro';
    ...
    class WPT_Product_Table{
        ...
        */
        ...
        public function include_defaults() {
            ...
            self::$columns_array =  $column_array;
            ...
            self::$default_enable_columns_array =  $default_enabled_col_array;
            /**
             * @since 1.7
             */
            self::$colums_disable_array = array(
                'product_id',
                'serial_number',
        ...
        public function plugins_loaded(){
            ...
            // Include Export Handler
            include_once $this->path('BASE_DIR','includes/export/export-handler.php');
...
new WPT_Product_Table();



if( ! function_exists( 'wpt_product_table_blocks_init' ) ){
