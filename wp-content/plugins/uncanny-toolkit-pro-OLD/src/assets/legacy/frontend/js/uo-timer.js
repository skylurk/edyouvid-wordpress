...
(function ($) {
    $(function () {
        ...
        var isUoBeatFree = false;

        $('body').append('<div id="btn-dialogBox" class="ultp-course-timer-modal"></div>');
        ...
        var uo_timer_logout = function () {
            $.ajax({
              type: 'POST',
              url: uoTimer.WPAdminURL,
              data: {
                'action'  : 'uo_wp_logout_user',
                'courseID': uoTimer.courseID,
                'nonce'   : uoTimer.timerLogoutNonce
              },
        ...
        var uo_timer_display_modal = function () {
        ...
        var check_if_active = function () {
            ...
            if ('true' === uoTimer.enableLogouMode && "" !== uoTimer.redirect) {
                uo_timer_logout();
            } else {
               uo_timer_display_modal();
            }
