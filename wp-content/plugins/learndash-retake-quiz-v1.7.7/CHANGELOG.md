...
- New: Retake reports for group admins
...
## 1.1
- New: Made the add-on compatible with LearnDash version 3.2
- New: Added option to enable/disable retake wrong questions, allow negative marking, and retake quiz delay features separately.
