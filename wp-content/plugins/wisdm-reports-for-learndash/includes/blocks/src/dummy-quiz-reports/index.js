    ...
    body = <div className="quiz-report-filters-wrapper wrld-dummy-filters">
      <div className="wrld-pro-note">
        <div className="wrld-pro-note-content">
          <span><b>{__('Note: ', 'learndash-reports-by-wisdmlabs')}</b>{__('Below is the dummy representation of the Quiz Reports available in LearnDash LMS - Reports PRO.', 'learndash-reports-by-wisdmlabs')}</span>
        </div>
      </div>
