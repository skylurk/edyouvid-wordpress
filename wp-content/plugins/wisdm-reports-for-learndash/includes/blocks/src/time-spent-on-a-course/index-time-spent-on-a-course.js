...
class TimeSpent extends Component {
  ...
  render() {
    ...
    const migration_tooltip_text = (
      <p>
        {__(
          "You need to run an data upgrade to see learner's earlier time spent information on this enhanced report. Click below to go to Time Tracking settings or navigate to WP Dashboard > LearnDash Reports > Settings > Time Tracking settings.",
          "learndash-reports-by-wisdmlabs"
        ) }
        <br/>
        <a
