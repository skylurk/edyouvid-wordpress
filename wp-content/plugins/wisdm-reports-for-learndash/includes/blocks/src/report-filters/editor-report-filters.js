        ...
        if (true!=this.state.isPro) {
            upgrade_section = <div className="wrld-pro-note">
                      <div className="wrld-pro-note-content">
                        <span><b>{__('Note: ', 'learndash-reports-by-wisdmlabs')}</b>{__('Below is the dummy representation of the Learner Reports available in LearnDash LMS - Reports PRO.', 'learndash-reports-by-wisdmlabs')}</span>
                      </div>
                    </div>
            proclass = 'ldr-pro';
