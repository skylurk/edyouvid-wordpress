    ...
    <div class={"wisdm-learndash-reports-chart-block " + data_validation} > 
      <div class="wisdm-learndash-reports-learner-pass-fail-rate-per-course graph-card-container">
        ...
        <div class="chart-header learner-pass-fail-rate-per-course-chart-header">
          ...
          <ChartSummarySection pro_upgrade_option={this.upgdare_to_pro} wrapper_class='chart-summary-learner-pass-fail-rate-per-course' graph_summary={this.state.graph_summary} error={this.state.error} pro_link="https://www.learndash.com/reports-by-learndash"/>
        </div>
        <div>
          {graph}
        </div>
