	...
	<div class="wrld-la-modal-content">
		<div class="wrld-la-modal-content-container2">
			...
			<div class="wrld-la-modal-head">
				...
				<span>Reports For LearnDash</span>
			</div>
			...
			<div class="special-section">
				...
				<div class="button2"><a href="<?php echo esc_url( 'https://www.learndash.com/reports-by-learndash' ); ?>" target="_blank">Upgrade Now</a></div>
			</div>
			<div class="table-section">
				<table class="features-table">
					<thead>
						<tr>
							<th>Power of the LearnDash LMS - Reports Free vs Pro</th>
							<th>Free</th>
							<th>Pro</th>
						</tr>
					</thead>
