					...
					<div class="wrld-ts-btn-container">
						...
						<div class="first-r-row description">		
							...
							<a href=<?php echo esc_url( $page_link ); ?> > <button class="wrld-ts-auto-button">
								...
								<?php esc_html_e( 'You can also perform this action at a later time by navigating to LearnDash Reports > Settings > Time Tracking settings.', 'learndash-reports-by-wisdmlabs' ); ?>								
						</div>
						</div>
					</div>
				</div>
