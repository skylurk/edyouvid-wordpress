...
class Learner_Activity_Onboarding {
	...
	public function show_marketing_modal() {
		...
		if ( ! defined( 'DOING_AJAX' ) || ! DOING_AJAX ) {
			...
			wp_enqueue_script( 'wrld_december_script', WRLD_REPORTS_SITE_URL . '/assets/js/wrld-modal-learner-activity.js', array( 'jquery' ), WRLD_PLUGIN_VERSION, true );
	...
	public function show_onboarding_modal( $page_link ) {
		...
		if ( ! defined( 'DOING_AJAX' ) || ! DOING_AJAX ) {
			...
			wp_enqueue_script( 'wrld_modal_la_script', WRLD_REPORTS_SITE_URL . '/assets/js/wrld-modal-learner-activity.js', array( 'jquery' ), WRLD_PLUGIN_VERSION, true );
			$modal_head = __(
