...
class Time_Spent_Onboarding {
	...
	public function wrld_time_spent_onboarding_logic() {
        ...
        // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.PreparedSQL.NotPrepared -- Custom safe query.
	...
	public function show_onboarding_modal( $page_link ) {
		...
		if ( ! defined( 'DOING_AJAX' ) || ! DOING_AJAX ) {
			...
			wp_enqueue_script( 'wrld_modal_ts_script', WRLD_REPORTS_SITE_URL . '/assets/js/wrld-modal-time-spent.js', array( 'jquery' ), WRLD_PLUGIN_VERSION, true );
			$modal_head = __(
