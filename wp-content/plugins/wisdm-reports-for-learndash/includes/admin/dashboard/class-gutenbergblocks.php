		...
		public static function get_current_installed_version_banner() {
			?>
				...
				<div class="wrld-gutenberg-header">
					<p><?php esc_html_e( 'Refer to this for a list of all reporting blocks.', 'learndash-reports-by-wisdmlabs' ); ?> <a href="https://www.learndash.com/support/docs/add-ons/reports-for-learndash/" target="_blank"><?php esc_html_e( 'Documentation', 'learndash-reports-by-wisdmlabs' ); ?><span class="dashicons dashicons-arrow-right-alt2"></span></a></p>
				</div>
			<?php
		}
