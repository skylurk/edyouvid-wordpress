		...
		public static function get_current_installed_version_banner() {
			?>
				...
				<div class="wrld-whatsnew-header">
					<h2>
						<?php esc_html_e( 'LearnDash LMS - Reports', 'learndash-reports-by-wisdmlabs' ); ?>
						<b>
							<?php esc_html_e( 'Version', 'learndash-reports-by-wisdmlabs' ); ?> <?php echo esc_html( WRLD_PLUGIN_VERSION ); ?>
						</b>
					</h2>
				</div>
			<?php
