...
<div class="wrld-whatsnew-post-container" id="wrld-post-img">
	...
	<div class="wrld-post-latest post-section-heading 
			...
			?>
	">
			<?php echo 0 == $key ? '<h2>' . esc_html__( 'Latest Version', 'learndash-reports-by-wisdmlabs' ) . '</h2><br/>' : ''; ?>
		<h2 class="wrld-version"><?php echo esc_html__( 'Version', 'learndash-reports-by-wisdmlabs' ); ?>
			<?php echo esc_html( $version->version_number ); ?>
        </h2>
		<span>
			<?php
	...
	<h2><?php echo esc_html__( 'Previous Versions ', 'learndash-reports-by-wisdmlabs' ); ?></h2><br/>
		<h2 class="wrld-version"><?php echo esc_html__( 'Version ', 'learndash-reports-by-wisdmlabs' ); ?>1.8.0</h2>
		...
		<li>' . esc_html__( 'The average time spent completing a course and the average time spent by learners currently enrolled in the course.', 'learndash-reports-by-wisdmlabs' ) . '</li>
		<li>' . esc_html__( 'Easily understand how much time it takes to complete a course.', 'learndash-reports-by-wisdmlabs' ) . '
		<li>' . esc_html__( 'Identify learners who spend very little time on the course or take too long to complete it.', 'learndash-reports-by-wisdmlabs' ) . '</li>
		<li>
		' . esc_html__( 'Visually grasp an overview of the time spent by all learners compared to the average time spent.', 'learndash-reports-by-wisdmlabs' ) . '</li>
		<li>
		' . esc_html__( 'Figure out in which courses a learner is spending most of the time and which courses by being neglected.', 'learndash-reports-by-wisdmlabs' ) . '</li>
		</ol>
		';
		include 'single-post-feature.php';
		?>
	...
	<div class="wrld-post-previous post-section-heading">
		...
		$is_latest        = true;
		$doc_config_link  = '';
        // Translators: %1$s: HTML link start tag, %2$s: HTML link close tag.
	...
	<div class="wrld-post-previous post-section-heading">
		<h2 class="wrld-version"><?php echo esc_html__( 'Version ', 'learndash-reports-by-wisdmlabs' ); ?>1.7.0</h2>
...
Additionally, these reports are available as Gutenberg blocks and can be used anywhere on the site.',
	...
	<div class="wrld-post-previous post-section-heading">
		<h2 class="wrld-version"><?php echo esc_html__( 'Version ', 'learndash-reports-by-wisdmlabs' ); ?>1.6.1</h2>
	...
	<div class="wrld-post-previous post-section-heading wrld-version-margin">
		<h2 class="wrld-version"><?php echo esc_html__( 'Version ', 'learndash-reports-by-wisdmlabs' ); ?>1.6.0</h2>
	...
	<div class="wrld-post-previous post-section-heading wrld-version-margin">
		<h2 class="wrld-version"><?php echo esc_html__( 'Version ', 'learndash-reports-by-wisdmlabs' ); ?> 1.5.0 </h2>
	...
	<div class="wrld-post-previous post-section-heading wrld-version-margin">
		...
		<h2 class="wrld-version"><?php echo esc_html__( 'Version ', 'learndash-reports-by-wisdmlabs' ); ?> 1.4.1</h2>
	...
	<div class="wrld-post-previous post-section-heading wrld-version-margin">
		<h2 class="wrld-version"><?php echo esc_html__( 'Version ', 'learndash-reports-by-wisdmlabs' ); ?> 1.4.0</h2>
	...
	<div class="wrld-post-previous post-section-heading wrld-version-margin">
		...
		<li>' . esc_html__( 'The learner - “opens another tab and leaves the current tab', 'learndash-reports-by-wisdmlabs' ) . '</li>
		<li>' . esc_html__( 'Or the learner is “Idle” (Idle Time) on the current tab such as:', 'learndash-reports-by-wisdmlabs' ) . '
		<br/>
		<ul>
		<li>' . esc_html__( 'the learner does not move the cursor', 'learndash-reports-by-wisdmlabs' ) . '</li>
		<li>
		' . esc_html__( 'the learner does not perform any keyboard strokes', 'learndash-reports-by-wisdmlabs' ) . '</li>
		</ul>
		</li>
