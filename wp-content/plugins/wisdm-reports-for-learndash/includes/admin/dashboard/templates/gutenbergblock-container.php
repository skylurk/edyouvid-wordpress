	...
	<div class="wrld-panel">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/course-progress.png' ); ?>"
						style="width:100%">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/cp-modal.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/cr-clt1.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/course-completion.png' ); ?>"
						style="width:100%">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/ccr-modal.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/time-tracking-revamp.png' ); ?>"
						style="width:100%">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/time-tracking-revamp-2.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/cr-rfc1.png' ); ?>"
						style="width:100%">
	...
	<div class="wrld-panel">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qr-qcr1.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qr-qct.png' ); ?>"
						style="width:100%">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qr-qct2.png' ); ?>"
						style="width:100%">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qr-qct3.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/aq-a1.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			<div class="wrld-feature-post-header">
				...
				<?php echo '<div class="wrld-feature-post-pro-tag">' . esc_html__( 'PRO', 'learndash-reports-by-wisdmlabs' ) . '</div>'; ?>
</div>
			</div>
			<div class="wrld-feature-post-content">
				<div class="wrld-post-info">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qr-qrv1.png' ); ?>"
						style="width:100%">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qr-qrv2.png' ); ?>"
						style="width:100%">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qr-qrv3.png' ); ?>"
						style="width:100%">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qr-qrv4.png' ); ?>"
						style="width:100%">
	...
	<div class="wrld-panel">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/lr-lpr1.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/lr-clt1.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/lr-tsc1.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/lr-st1.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/lr-sp1.png' ); ?>"
						style="width:100%">
	...
	<div class="wrld-panel">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/ar-la1.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/ar-iul1.png' ); ?>"
						style="width:100%">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/ar-iul2.png' ); ?>"
						style="width:100%">
	...
	<div class="wrld-panel">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qs-tr.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qs3.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qs2.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qs1.png' ); ?>"
						style="width:100%">
		...
		<div class="wrld-feature-post">
			...
			<div class="wrld-feature-post-content">
				...
				<div class="wrld-post-images wrld-slider-container">
					<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qs-de1.png' ); ?>"
						style="width:100%">
						<img class="mySlides" onclick="wrldShowmodal(this,this.parentElement);"
						src="<?php echo esc_url( WRLD_REPORTS_SITE_URL . '/includes/admin/dashboard/assets/images/tabs/gutenberg/qs-de2.png' ); ?>"
						style="width:100%">
