...
if ( ! class_exists( 'Dashboard' ) ) {
	...
	class Dashboard {
		...
		public function page_init() {
			...
			$page_title     = esc_html__( 'Reports For LearnDash', 'learndash-reports-by-wisdmlabs' );
...
<div class='wrld-tab-wrapper nav-tab-wrapper'>
			...
			foreach ( $tabs as $tab => $title ) {
				...
				if ( 'wrld-whatsnew' === $tab && ! get_option( 'wrld_whats_new_tab_visited', false ) ) {
				...
				} elseif ( 'wrld-gutenbergblocks' === $tab && ! ( get_option( 'wrld_gutenberg_block_course_report', false ) && get_option( 'wrld_gutenberg_block_quiz_report', false ) && get_option( 'wrld_gutenberg_block_learner_report', false ) && get_option( 'wrld_gutenberg_block_activity_report', false ) && get_option( 'wrld_gutenberg_block_quick_stats', false ) ) ) {
					echo '<a id="' . esc_attr( $tab_og ) . '" class="nav-tab' . esc_attr( $class ) . '" href="admin.php?page=' . esc_attr( $tab ) . '">' . esc_html( $title ) . '<span class="whatsnew-beacon-icon wrld-blink"> </span></a>';
				} else {
