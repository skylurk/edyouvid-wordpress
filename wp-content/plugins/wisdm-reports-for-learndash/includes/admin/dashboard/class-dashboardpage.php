...
if ( ! class_exists( 'DashboardPage' ) ) {
	...
	class DashboardPage {
			...
			?>
				<div class='wrld-dashboard-page-content'>
					<div>
						...
						<br/>
						<span class="wrld-dashboard-text"> <?php esc_html_e( 'Unlock the benefits of the Student Quiz Reports by upgrading to LearnDash LMS - Reports PRO.', 'learndash-reports-by-wisdmlabs' ); ?> </span>
					</div>
					<div class='wrld-dashboard-action'>
						<a href="<?php echo esc_url( 'https://www.learndash.com/reports-by-learndash' ); ?>" target="_blank">
						<button class='wrld-dashboard-button-action secondary'><?php esc_html_e( 'Upgrade to PRO', 'learndash-reports-by-wisdmlabs' ); ?></button>
						</a>
					</div>
				</div>
			<?php
		...
		public static function content_when_student_not_configured( $wrld_page, $settings_data ) {
			...
			$add_student_menu_link = isset( $settings_data['wrld-menu-student-setting'] ) && ( 'true' === strval( $settings_data['wrld-menu-student-setting'] ) ) ? true : false;
