			...
			?>
				<div class='wrld-dashboard-page-content licensing'>
					<div>
						...
						<br/><br/>
						<span class='wrld-dashboard-text'> <?php esc_html_e( 'Activating the License Key is essential to receive regular plugin updates as well as support from LearnDash.', 'learndash-reports-by-wisdmlabs' ); ?> </span>
						<br/>
						<?php
		...
		public static function sidebar_block_help() {
			...
			<div class='wrld-sidebar-block licensing'>
					...
					<div class='wrld-sidebar-body licensing'>
						<ul>
							<li>
								<a href="https://www.learndash.com/support/docs/add-ons/reports-for-learndash/" target='__blank'><?php esc_html_e( 'Documentation', 'learndash-reports-by-wisdmlabs' ); ?></a>
							</li>
							<li>
								<?php esc_html_e( 'Talk to us: ', 'learndash-reports-by-wisdmlabs' ); ?><a href="mailto:support@learndash.com" target='__blank'>support@learndash.com</a>
							</li>
						</ul>
					</div>
				</div>
		...
		public static function get_licensing_section() {
			...
			<div class='wrld-dashboard-licence-tool-container' data-nonce='<?php echo esc_html( wp_create_nonce( 'edd_learndash-reports-pro_nonce' ) ); ?>'>
				<div class='wrld-license-header-section'>
					<div class='wrld-license-header key'><?php esc_html_e( 'Reports for LearnDash PRO', 'learndash-reports-by-wisdmlabs' ); ?>
					</div>
				...
				<div class='wrld-license-body'>
					<div class='wrld-license-cell key'>
						<input type="text" name="wrld-pro-license-key" id="wrld-pro-license-key" value='<?php echo esc_html( $license_key ); ?>' placeholder='<?php esc_html_e( 'Enter license key', 'learndash-reports-by-wisdmlabs' ); ?>' <?php disabled( 'valid' === strval( $status ) ); ?>>
					</div>
