...
class Admin_Functions {
	...
	public static function wp_ajax_wrld_gutenberg_block_visit() {
		...
		if ( ! wp_verify_nonce( $nonce, 'wrld-admin-settings' ) ) {
			wp_send_json_error( esc_html__( "You don't have permission to do this action.", 'learndash-reports-by-wisdmlabs' ) );
		}
		...
		if ( empty( $option_key ) ) {
			wp_send_json_error( esc_html__( 'Invalid option key.', 'learndash-reports-by-wisdmlabs' ) );
		}
...
<div class="wrap">
	...
	public static function report_page_creation_notice() {
		...
		echo esc_html__( 'Successfully created Reports For LearnDash page', 'learndash-reports-by-wisdmlabs' );
		echo '</p></div>';
	}
	...
	public static function report_student_page_creation_notice() {
		echo '<div class="notice notice-success is-dismissible"><p>';
		echo esc_html__( 'Successfully created Reports For LearnDash Student Quiz Reports page', 'learndash-reports-by-wisdmlabs' );
		echo '</p></div>';
	}
