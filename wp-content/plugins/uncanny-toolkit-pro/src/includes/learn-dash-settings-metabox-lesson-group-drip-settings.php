			...
			if ( ! isset( $_GET['course_id'] ) ) {
				...
				if ( 'yes' === LearnDash_Settings_Section::get_section_setting( 'LearnDash_Settings_Courses_Builder', 'shared_steps' )
					...
					if ( ! empty( $lessons_course_id ) ) {
						...
						$item_url = add_query_arg( 'currentTab', 'uo-toolkit-lessons', $item_url );
					...
					if ( $group && is_object( $group ) ) {
                        ...
                        >
                            ...
                            <td class="uo-ld-group-drip-row__actions">
                                <button type="button"
                                        class="uo-ld-group-drip__action uo-ld-group-drip__action--save uncannyowl-btn uncannyowl-btn--primary">
									<?php esc_attr_e( 'Save date', 'uncanny-pro-toolkit' ); ?>
                                </button>

                                <button type="button"
                                        class="uo-ld-group-drip__action uo-ld-group-drip__action--remove uncannyowl-btn uncannyowl-btn--secondary">
